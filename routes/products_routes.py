...
def detalhes(produto_id):
    ...
    if not produto:
        abort(404)
    relacionados = Product.relacionados(produto["categoria"], produto_id)
    return render_template("products/products_details.html", produto=produto, relacionados=relacionados)